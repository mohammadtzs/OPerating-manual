...
Version validation is a strict, critical requirement. To securely hand over upgradability to the Collective, a chain’s L1 smart contracts must be deployed by the canonical OP Contracts Manager ("OPCM") address on Ethereum, [`0xfa1ef97fb02b0da2ee2346b8e310907ab5519449`](https://etherscan.io/address/0xfa1ef97fb02b0da2ee2346b8e310907ab5519449). This is an automated L1 deployment contract which deploys chains based on `op-contracts@v5.0.0`.
